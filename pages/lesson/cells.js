...
export default function LessonPage() {
  ...
  const data = {"title": "Cells", "lesson": "Cells are the basic building blocks of all living organisms.", "question": "What controls the activities of a cell?", "options": ["Nucleus", "Membrane", "Ribosome", "Mitochondria"], "answer": "Nucleus"};
