...
export default function LessonPage() {
  ...
  const data = {"title": "Microscopy", "lesson": "Microscopes allow us to see small structures like cells.", "question": "Which microscope has higher resolution?", "options": ["Light Microscope", "Electron Microscope"], "answer": "Electron Microscope"};
